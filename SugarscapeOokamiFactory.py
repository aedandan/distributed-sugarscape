...
try:
    q = wq.WorkQueue(name="sugarscape_no_batch", debug_log = "my.debug.log", transactions_log="my.transaction.log", port=9124)
...
workers.max_workers = 47
workers.min_workers = 47
workers.memory = 8192
workers.cores = 48
